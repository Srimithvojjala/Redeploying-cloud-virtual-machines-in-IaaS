...
PreparedStatement ps=con.prepareStatement("select * from domainreg where domainname='"+username1+"'  ");
ResultSet rs=ps.executeQuery();

 if(rs.next())
       {%>
     <center><h1>Domain Already exist</h1></center>
 <% }
else
       {
     response.sendRedirect("domainreg.jsp");}
}
