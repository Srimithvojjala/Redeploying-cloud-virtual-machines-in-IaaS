...
<ul>
   ...
   <li class='last'><a href='registration.jsp'><span>Registration</span></a></li>
        ...
        <table align="left">
       <tr>
           <td align="center"><img src="images/7.jpg" hight="200" width="200" ></td></table>
        		<form name="myForm" method="get" action="userlogin1.jsp"  onSubmit="return validate();">
              <table width="40" align="center">
                  <center><h1>Cloud User login</h1></center>
       <tr>
                  <td width="30"><font color="blue">Name:</font><br/></td>
                  <td><input type="text" size=30 maxlength=30  name="name" placeholder="username"></td>
    </tr>
    <tr>
