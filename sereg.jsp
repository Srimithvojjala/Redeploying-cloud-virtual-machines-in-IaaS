...
<ul>
   ...
   <li class='last'><a href='registration.jsp'><span>Registration</span></a></li>
         ...
         <table align="left">
       <tr>
           <td align="center"><img src="images/6.jpg" hight="300" width="300" ></td></table>
        <center><h1>Service Provider registration</h1></center>
     <form name="myForm" method="get" action="sreg.jsp"  onSubmit="return validate();">
    ...
    <tr>
        <td width="30"><font color="blue">Select Security Question:</font></td>
          <td><select name="que" color="white" maxlength=30 onchange="">
              <option selected="selected" color="white" value="">---Select---</option>
              <option value="sch" color="white">Your First School Name</option>
              <option value="pet" color="white">Your Pet Name</option>
              <option value="mot" color="white">Your Mothers Middle</option>

            </select></td>
        </tr>
         <tr>
        <td width="30"><font color="blue">Enter Answer:</font><br/></td>
        <td><input type="text" size=30 maxlength=30  name="answer"></td>
    </tr>
    <tr>
        <td ><input type="Reset">
