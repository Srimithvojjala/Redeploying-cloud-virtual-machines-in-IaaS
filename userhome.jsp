...
<ul>
   ...
   <li class='last'><a href='index.jsp'><span>Logout</span></a></li>
    ...
    <h2>Domain Name Options </h2>
    <form name="myForm" method="get" action="search1.jsp"  onSubmit="return validate();">
 <table align="center">
     <center> <h3>I Want To Register Domain for My First Year Hosting </h3></center>
     <tr>
                  <td width="30"><font color="black">Enter Domain Name</font><br/></td>
